...
export function parseEffect (effect, level) {
  const actionsData = openFile('data/raw/cdn/actions.json')
  const statesData = openFile('data/raw/cdn/states.json')
  const jobsData = openFile('data/raw/cdn/recipeCategories.json')
